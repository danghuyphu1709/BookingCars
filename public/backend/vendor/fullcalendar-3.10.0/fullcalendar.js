    ...
    */
    UnzonedRange.invertRanges = function (ranges, constraintRange) {
        ...
        for (i = 0; i < ranges.length; i++) {
            dateRange = ranges[i];
            // add.blade.php the span of time before the event (if there is any)
        ...
        // add.blade.php the span of time after the last event (if there is any)
...
newMomentProto.time = function (time) {
    ...
    if (time == null) { // getter
        ...
        // Can't use startOf('day') then add.blade.php duration. In case of DST at start of day.
...
var momComputableOptions = {
    ...
    dayOfMonthFormat: function (momOptions, fcOptions) {
        ...
        if (fcOptions.isRTL) {
            format += ' ddd'; // for RTL, add.blade.php day-of-week to end
        }
        else {
            format = 'ddd ' + format; // for LTR, add.blade.php day-of-week to beginning
        }
        return format;
    },
...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.updateNowIndicator = function () {
        if (this.isDatesRendered &&
            ...
            this.renderNowIndicator(this.initialNowDate.clone().add(new Date().valueOf() - this.initialNowQueriedMs) // add.blade.php ms
            );
...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
        ...
        if (t.rowCnt === 1) {
            ...
            classNames.push('fc-' + util_1.dayIDs[date.day()]); // only add.blade.php the day-of-week class
        }
        return '' +
    ...
    EventManager.prototype.mutateEventsWithId = function (eventDefId, eventDefMutation) {
        ...
        if (currentPeriod) {
            ...
            eventDefs.forEach(function (eventDef) {
                // add.blade.php/remove esp because id might change
...
var RenderQueue = /** @class */ (function (_super) {
    ...
    RenderQueue.prototype.compoundTask = function (newTask) {
        ...
        if (newTask.namespace && newTask.type === 'destroy') {
            // remove all init/add.blade.php/remove ops with same namespace, regardless of order
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.applyTimezone = function (date) {
        ...
        if (timeAdjust) { // is the time result different than expected?
            adjustedZonedDate = zonedDate.clone().add(timeAdjust); // add.blade.php milliseconds
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.generateFgSegHorizontalCss = function (seg) {
        ...
        if (shouldOverlap && seg.forwardPressure) {
            // add.blade.php padding to the edge so that forward stacked events don't cover the resizer's icon
